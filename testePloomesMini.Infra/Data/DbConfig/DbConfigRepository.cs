...
namespace testePloomesMini.Infra.Data.DbConfig
{
    public class DbConfigRepository
    {
        ...
        public List<T> ExecuteList<T>(EnviromentDb.Enviroment db, string procedureName, object parameters)
        {
        ...
        public T ExecuteSelect<T>(EnviromentDb.Enviroment db, string procedureName, object parameters)
        {
            DataTable dt = ExecuteTable(db, procedureName, parameters);
        ...
        public DataTable ExecuteTable(EnviromentDb.Enviroment db, string procedureName, object parameters)
        {
        ...
        public int ExecuteNonQuery(EnviromentDb.Enviroment db, string procedureName, object parameters)
        {
            int id = 0;
            using (var conn = new SqlConnection(GetConnectionString(db)))
            {
        ...
        private string GetConnectionString(EnviromentDb.Enviroment db)
        {
